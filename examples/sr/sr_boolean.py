...
toolbox.register('mutate', gep.mutUniform, pset=pset, indpb=2 / (2*h + 1))
toolbox.register('invert', gep.invert)
toolbox.register('isTranspose', gep.isTranspose)
toolbox.register('risTranspose', gep.risTranspose)
toolbox.register('geneTranspose', gep.geneTranspose)
